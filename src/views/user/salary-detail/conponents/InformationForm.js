      ...
      >
        <div className="container">
            ...
            <table className="attendance-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td rowSpan={11}>{values?.employee_no}</td>
                  <td rowSpan={11}>
                    <div className="col">
                      <p className="mb-3 text-small">{`${values?.first_name_th} ${values?.last_name_th}`}</p>
                      <p className="mb-3 text-small">{values?.first_name_en ? `${values?.first_name_en} ${values?.last_name_en}` : ' '}</p>
                      <p className="mb-1 text-small">วันเริ่มงาน</p>
                      <p className="text-small">{values?.start_at ? moment(values?.start_at).format('DD-MM-YYYY') : '-'}</p>
                    </div>
                  </td>
                        ...
                        return (
                          ...
                          >
                            <Form.Control
                              ...
                              className="border-0"
                              type="text"
                              value={list.working_time}
                              onChange={(e) => handleChangeValue(e.target.value, list)}
                            />
                          </td>
                        );
                      })}
          ...
          <div className="request-details">
            ...
            <Form.Control as="textarea" name="description" defaultValue={values?.description} onChange={handleChange} />
          </div>
        </div>
      </Card>
